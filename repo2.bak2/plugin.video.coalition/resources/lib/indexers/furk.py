...
default_furk_icon = kodi_utils.translate_path('special://home/addons/plugin.video.coalition/resources/media/furk.png')
...
def add_to_files(item_id):
	...
	if Furk.check_status(response): kodi_utils.notification(32576)
