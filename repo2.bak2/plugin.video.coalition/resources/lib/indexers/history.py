...
icon = kodi_utils.translate_path('special://home/addons/plugin.video.coalition/resources/media/search.png')
search_icon = kodi_utils.translate_path('special://home/addons/plugin.video.coalition/resources/media/search_history.png')
...
def search_history(params):
	...
	kodi_utils.add_dir(action_dict, new_search_str, __handle__, iconImage=icon, isFolder=False)
...
def get_search_term(params):
	...
	query = params_query or kodi_utils.dialog.input('coalition')
	if not query: return
	query = unquote(query)
