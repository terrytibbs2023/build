...
def skin_location():
	return translate_path('special://home/addons/plugin.video.coalition')
...
def auto_start_coalition():
	return get_setting('auto_start_coalition') == 'true'
...
def nextep_content_settings():
	...
	sort_key = 'coalition_last_played' if sort_type == 0 else 'coalition_first_aired' if sort_type == 1 else 'coalition_name'
...
def fanarttv_client_key():
	return get_setting('fanart_client_key', '598515b970d81280063107d49d0e2558')

def tmdb_api_key():
	return get_setting('tmdb_api', '74f3ce931d65ebda1f77ef24eac2625f')
