...
from tmdbbingiehelper.lib.addon.plugin import convert_type, get_localized, get_setting
from tmdbbingiehelper.lib.addon.dialog import progress_bg
...
class ListAiringNext(ContainerDirectory):
    ...
    def get_list_items(self, seed_items: list, prefix: str, reverse: bool = False, **kwargs):
        ...
        from tmdbbingiehelper.lib.addon.tmdate import date_in_range, is_future_timestamp
...
class ListTraktAiringNext(ListAiringNext):
    ...
    def get_items(self, **kwargs):
        ...
        if not self.trakt_api or not self.trakt_api.trakt_syncdata:
            return False
