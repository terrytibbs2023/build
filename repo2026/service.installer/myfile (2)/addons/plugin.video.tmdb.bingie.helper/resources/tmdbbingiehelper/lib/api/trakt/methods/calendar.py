...
def get_calendar_episodes(self, startdate=0, days=1, user=True, endpoint=None):
    ...
    from tmdbbingiehelper.lib.addon.tmdate import get_datetime_today, get_timedelta
...
def get_calendar_episode_item(i):
    from bingie.parser import try_int
    from tmdbbingiehelper.lib.addon.tmdate import convert_timestamp, get_region_date, get_days_to_air
...
def get_calendar_episode_item_bool(i, kodi_db, user, startdate, days):
    from tmdbbingiehelper.lib.addon.tmdate import date_in_range
