import xbmcgui
from tmdbbingiehelper.lib.addon.plugin import get_infolabel, get_condvisibility, get_localized, get_setting, get_skindir
from tmdbbingiehelper.lib.addon.logger import kodi_try_except
from bingie.window import get_property, get_current_window
from tmdbbingiehelper.lib.monitor.common import CommonMonitorFunctions, SETMAIN_ARTWORK, SETPROP_RATINGS
from tmdbbingiehelper.lib.monitor.itemdetails import ListItemDetails
from tmdbbingiehelper.lib.monitor.readahead import ListItemReadAhead, READAHEAD_CHANGED
from tmdbbingiehelper.lib.monitor.baseitem import BaseItemSkinDefaults
...
CV_USE_LISTITEM = (
    "!Skin.HasSetting(TMDbBingieHelper.ForceWidgetContainer) + "
    "!Window.IsActive(script-tmdbbingiehelper-recommendations.xml) + ["
    "!Skin.HasSetting(TMDbBingieHelper.UseLocalWidgetContainer) | String.IsEmpty(Window.Property(TMDbBingieHelper.WidgetContainer))] + ["
...
CV_USE_LOCAL_CONTAINER = "Skin.HasSetting(TMDbBingieHelper.UseLocalWidgetContainer)"
...
class ListItemMonitorFunctions(CommonMonitorFunctions, ListItemInfoGetter):
    ...
    def listcontainer_id(self):
        return int(get_infolabel('Skin.String(TMDbBingieHelper.MonitorContainer)') or 0)
    ...
    def on_finalise(self):
        ...
        func(
            process_artwork=get_condvisibility("!Skin.HasSetting(TMDbBingieHelper.DisableArtwork)"),
            process_ratings=get_condvisibility("!Skin.HasSetting(TMDbBingieHelper.DisableRatings)"))
    ...
    def on_listitem(self):
        ...
        if get_condvisibility("!Skin.HasSetting(TMDbBingieHelper.DisablePersonStats)"):
