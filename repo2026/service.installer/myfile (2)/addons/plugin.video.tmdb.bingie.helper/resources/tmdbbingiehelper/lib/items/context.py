...
CONTEXT_MENU_ITEMS = {
    # Browse Lists
    '$ADDON[plugin.video.tmdb.bingie.helper 32235]': {
        'command': 'RunScript(plugin.video.tmdb.bingie.helper,related_lists,{})',
    ...
    # Trakt Options
    '$ADDON[plugin.video.tmdb.bingie.helper 32295]': {
        'command': 'RunScript(plugin.video.tmdb.bingie.helper,sync_trakt,{})',
    ...
    # TMDb User Options
    '$ADDON[plugin.video.tmdb.bingie.helper 32522]': {
        'command': 'RunScript(plugin.video.tmdb.bingie.helper,sync_tmdb,{})',
        'setting': 'contextmenu_sync_tmdb',
        'episode': {'tmdb_type': '{tmdb_type}', 'tmdb_id': '{tmdb_id}', 'season': '{season}', 'episode': '{episode}'},
        'other': {'tmdb_type': '{tmdb_type}', 'tmdb_id': '{tmdb_id}'}
    },
    # Manage Artwork
    '$ADDON[plugin.video.tmdb.bingie.helper 32222]': {
        'command': 'RunScript(plugin.video.tmdb.bingie.helper,manage_artwork,{})',
    ...
    # Refresh Details
    '$ADDON[plugin.video.tmdb.bingie.helper 32233]': {
        'command': 'RunScript(plugin.video.tmdb.bingie.helper,refresh_details,{})',
    ...
    # Add to Library
    '$LOCALIZE[20444]': {
        'command': 'RunScript(plugin.video.tmdb.bingie.helper,add_to_library,{})',
