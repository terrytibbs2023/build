...
from tmdbbingiehelper.lib.addon.plugin import get_plugin_category, get_localized, PLUGINPATH
from tmdbbingiehelper.lib.addon.consts import MDBLIST_LIST_OF_LISTS
...
class ListCustomSearch(ContainerDirectory):
    def get_items(self, query=None, **kwargs):
        if not query:
            ...
            if not kwargs['query']:
                return
            from tmdbbingiehelper.lib.addon.plugin import encode_url
