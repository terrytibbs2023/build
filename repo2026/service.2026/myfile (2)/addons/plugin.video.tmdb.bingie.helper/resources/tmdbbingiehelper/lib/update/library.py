...
from tmdbbingiehelper.lib.addon.plugin import get_setting, get_localized, set_setting
from bingie.parser import try_int
from tmdbbingiehelper.lib.addon.tmdate import is_unaired_timestamp, get_current_date_time
from tmdbbingiehelper.lib.files.futils import validify_filename, get_tmdb_id_nfo
from tmdbbingiehelper.lib.update.logger import _LibraryLogger
from tmdbbingiehelper.lib.update.update import BASEDIR_MOVIE, BASEDIR_TV, STRM_MOVIE, STRM_EPISODE, create_file, create_nfo, get_unique_folder
from tmdbbingiehelper.lib.update.cacher import _TVShowCache
from tmdbbingiehelper.lib.update.common import LibraryCommonFunctions
...
class LibraryAdder(LibraryCommonFunctions):
    def __init__(self, busy_spinner=True):
        ...
        self._msg_title = 'TMDbBingieHelper Library'
