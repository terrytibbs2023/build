...
class TMDbImagePath:
    ...
    def artwork_quality_poster(self):
        from tmdbbingiehelper.lib.addon.consts import IMAGEPATH_QUALITY_POSTER
        return IMAGEPATH_QUALITY_POSTER[self.artwork_quality]

    @cached_property
    def artwork_quality_fanart(self):
        from tmdbbingiehelper.lib.addon.consts import IMAGEPATH_QUALITY_FANART
        return IMAGEPATH_QUALITY_FANART[self.artwork_quality]

    @cached_property
    def artwork_quality_thumbs(self):
        from tmdbbingiehelper.lib.addon.consts import IMAGEPATH_QUALITY_THUMBS
        return IMAGEPATH_QUALITY_THUMBS[self.artwork_quality]

    @cached_property
    def artwork_quality_clogos(self):
        from tmdbbingiehelper.lib.addon.consts import IMAGEPATH_QUALITY_CLOGOS
        return IMAGEPATH_QUALITY_CLOGOS[self.artwork_quality]

    @cached_property
    def artwork_quality_origin(self):
        from tmdbbingiehelper.lib.addon.consts import IMAGEPATH_ORIGINAL
        return IMAGEPATH_ORIGINAL

    @cached_property
    def artwork_quality_negate(self):
        from tmdbbingiehelper.lib.addon.consts import IMAGEPATH_NEGATE
