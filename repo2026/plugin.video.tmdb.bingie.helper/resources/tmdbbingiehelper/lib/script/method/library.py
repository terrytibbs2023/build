...
from tmdbbingiehelper.lib.script.method.decorators import is_in_kwargs, choose_tmdb_id
...
def run_autoupdate(**kwargs):
    ...
    from tmdbbingiehelper.lib.update.userlist import library_autoupdate
