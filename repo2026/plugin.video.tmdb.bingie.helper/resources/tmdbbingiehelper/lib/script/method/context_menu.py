...
def related_lists(tmdb_id=None, tmdb_type=None, season=None, episode=None, container_update=True, include_play=False, **kwargs):
    ...
    from tmdbbingiehelper.lib.items.basedir import get_basedir_details
    from tmdbbingiehelper.lib.addon.plugin import format_folderpath, encode_url, executebuiltin
