...
class NextEpisode(BaseDialog):
	...
	def set_properties(self):
		...
		self.setProperty('episode_status.highlight', self.episode_status_dict[episode_type])
		self.setProperty('episode_status.flag', 'bingie_flags/episodes/%s.png' % episode_type)
