...
from indexers import people, metadata, watched as ws
...
backup_poster = translate_path('special://home/addons/plugin.video.coalition/resources/media/box_office.png')
backup_fanart = translate_path('special://home/addons/plugin.video.coalition/fanart.png')
backup_thumbnail = translate_path('special://home/addons/plugin.video.coalition/resources/media/box_office.png')
backup_cast_thumbnail = translate_path('special://home/addons/plugin.video.coalition/resources/media/people.png')
		...
		if action in self.context_actions:
			...
			if focus_id == playbrowse_id and self.media_type == 'movie':
				...
				params = {'action': 'image', 'name': '%s %s' % (self.rootname, chosen_listitem.getProperty('tikiskins.extras.name')),
						...
						'media_type': 'image', 'image': translate_path('special://home/addons/plugin.video.coalition/icon.png')}
		...
		def builder():
			for item in data:
				try:
					...
					icon = translate_path('special://home/addons/plugin.video.coalition/resources/media/%s' % parentsguide_inputs[item['title']][1])
