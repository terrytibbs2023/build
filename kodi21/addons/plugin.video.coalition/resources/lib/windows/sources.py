...
media_folder = 'special://home/addons/plugin.video.coalition/resources/skins/Default/media/%s'
...
class SourceResults(BaseDialog):
	...
	def get_provider_and_path(self, provider):
		...
		else: provider, provider_path = 'folders', translate_path('special://home/addons/plugin.video.coalition/resources/skins/Default/media/providers/folders.png')
...
class ResultsInfo(BaseDialog):
	...
	def get_provider_and_path(self):
		...
		if provider in info_icons_dict: provider_path = info_icons_dict[provider]
		else: provider_path = translate_path('special://home/addons/plugin.video.coalition/resources/skins/Default/media/providers/folders.png')
		return provider, provider_path
