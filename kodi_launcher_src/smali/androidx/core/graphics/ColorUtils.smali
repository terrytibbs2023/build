...
.method public static compositeColors(Landroid/graphics/Color;Landroid/graphics/Color;)Landroid/graphics/Color;
    ...
    .line 92
    invoke-static {p0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)Landroid/graphics/ColorSpace$Model;

    move-result-object v0

    invoke-static {p1}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)Landroid/graphics/ColorSpace$Model;
    ...
    .line 98
    invoke-static {p1}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)Landroid/graphics/ColorSpace;

    move-result-object v0

    invoke-static {p0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)Landroid/graphics/ColorSpace;
    ...
    invoke-static {p0, v0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;Landroid/graphics/ColorSpace;)Landroid/graphics/Color;

    move-result-object p0

    .line 102
    :goto_0
    invoke-static {p0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)[F

    move-result-object v0

    .line 103
    invoke-static {p1}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)[F
    ...
    .line 111
    invoke-static {p1}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Color;)I
    ...
    invoke-static {v1, p0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m([FLandroid/graphics/ColorSpace;)Landroid/graphics/Color;
