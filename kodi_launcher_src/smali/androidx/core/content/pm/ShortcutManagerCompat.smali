...
.method public static addDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    .line 186
    :cond_0
    invoke-static {}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m$1()Ljava/lang/Class;
    ...
    invoke-static {v1}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;

    move-result-object v1

    invoke-static {v1, v0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Ljava/util/List;)Z
...
.method public static createShortcutResultIntent(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Landroid/content/Intent;
    ...
    invoke-static {p0, v0}, Landroidx/core/app/Person$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p0

    invoke-static {p0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
    ...
    invoke-static {p0, v0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Landroid/content/pm/ShortcutInfo;)Landroid/content/Intent;
...
.method public static getDynamicShortcuts(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {v0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;

    move-result-object v0

    .line 219
    invoke-static {v0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;)Ljava/util/List;
    ...
    invoke-static {v2}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method public static getMaxShortcutCountPerActivity(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;)I
...
.method public static isRequestPinShortcutSupported(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;)Z
...
.method public static removeAllDynamicShortcuts(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;)V
...
.method public static requestPinShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;Landroid/content/IntentSender;)Z
    ...
    .line 114
    invoke-static {p0, p1, p2}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;)Z
...
.method public static updateShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    invoke-static {v1, v0}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/ShortcutManager;Ljava/util/List;)Z
...
.method public removeDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {v0, p2}, Landroidx/core/os/HandlerCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
