...
class TMDbListAPI:
	...
	def get_user_lists(self):
		...
		def _process(dummy):
			...
			return results
		account_id = get_setting('bingie.tmdb.account_id')
	...
	def request_data(self, url, params=None, data=None, method='get'):
		headers = {'accept': 'application/json', 'content-type': 'application/json', 'Authorization': 'Bearer %s' % get_setting('bingie.tmdb.token')}
