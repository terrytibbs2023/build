import xbmcvfs
import bingie.futils
from bingie.parser import try_int
from tmdbbingiehelper.lib.addon.plugin import ADDONDATA, get_localized, get_setting
from tmdbbingiehelper.lib.addon.logger import kodi_log


class FileUtils(bingie.futils.FileUtils):
...
json_loads = bingie.futils.json_loads
json_dumps = bingie.futils.json_dumps
validate_join = bingie.futils.validate_join
validify_filename = bingie.futils.validify_filename
get_filecache_name = bingie.futils.get_filecache_name
...
def set_json_filecache(my_object, cache_name, cache_days=14):
    ...
    from tmdbbingiehelper.lib.addon.tmdate import get_timedelta, get_datetime_now
