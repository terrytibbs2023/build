from tmdbbingiehelper.lib.addon.plugin import get_mpaa_prefix, get_language, get_setting
from tmdbbingiehelper.lib.addon.consts import CACHE_SHORT, CACHE_MEDIUM
from tmdbbingiehelper.lib.api.request import RequestAPI
from tmdbbingiehelper.lib.api.tmdb.mapping import ItemMapper
from tmdbbingiehelper.lib.api.tmdb.content import TMDbMethods
from tmdbbingiehelper.lib.api.api_keys.tmdb import API_KEY
...
class TMDb(TMDbAPI, TMDbMethods):
    ...
    artlang_fallback = True if get_setting('fanarttv_enfallback') and not get_setting('fanarttv_lookup') else False
    api_name = 'TMDb'
