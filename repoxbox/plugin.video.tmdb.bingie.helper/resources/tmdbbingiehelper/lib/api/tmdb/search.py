...
from tmdbbingiehelper.lib.addon.plugin import ADDONPATH, PLUGINPATH, convert_type, get_localized
from bingie.parser import merge_two_dicts
...
class ListSearch(ContainerDirectory):
    def get_items(self, tmdb_type, query=None, update_listing=False, page=None, **kwargs):
        ...
        if not query:
            from tmdbbingiehelper.lib.addon.consts import PARAM_WIDGETS_RELOAD_FORCED
