...
from bingie.checks import has_arg_value
from tmdbbingiehelper.lib.addon.consts import LASTACTIVITIES_DATA
from tmdbbingiehelper.lib.api.trakt.sync.database import SyncDataBase
...
class SyncDataGetterAllUnHidden(SyncDataGetterAll):
    query_clauses = ('item_type=?', 'dropped_hidden_at IS NULL', )
