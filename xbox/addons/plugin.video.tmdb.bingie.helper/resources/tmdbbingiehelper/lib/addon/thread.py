...
from tmdbbingiehelper.lib.addon.plugin import get_setting, encode_url
...
import bingie.thread as bingie_thread


SafeThread = bingie_thread.SafeThread
...
class ParallelThread(bingie_thread.ParallelThread):
