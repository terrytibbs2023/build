...
from tmdbbingiehelper.lib.update.userlist import get_monitor_userlists
from tmdbbingiehelper.lib.addon.logger import kodi_log
from tmdbbingiehelper.lib.addon.plugin import get_localized
from tmdbbingiehelper.lib.api.kodi.rpc import get_kodi_library, set_tags
...
from tmdbbingiehelper.lib.update.update import create_playlist
...
class LibraryTagger(LibraryCommonFunctions):
    def __init__(self, busy_spinner=True):
        ...
        self._msg_title = 'TMDbBingieHelper Tagger'
        self._start()
        self.update_tags()
        self._finish()
