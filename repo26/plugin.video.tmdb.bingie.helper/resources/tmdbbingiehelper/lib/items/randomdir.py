...
from tmdbbingiehelper.lib.addon.consts import RANDOMISED_LISTS, RANDOMISED_TRAKT
...
class ListRandom(ContainerDirectory):
    def get_items(self, **kwargs):
        ...
        try:
            del self.tmdb_cache_only  # Avoid inheriting cache settings from seed item
