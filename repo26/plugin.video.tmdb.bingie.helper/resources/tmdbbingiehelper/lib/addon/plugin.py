...
KODIPLUGIN = bingie.plugin.KodiPlugin('plugin.video.tmdb.bingie.helper')
ADDON = KODIPLUGIN._addon
ADDONPATH = KODIPLUGIN._addon_path
ADDONNAME = KODIPLUGIN._addon_name
ADDONDATA = 'special://profile/addon_data/plugin.video.tmdb.bingie.helper/'
PLUGINPATH = u'plugin://plugin.video.tmdb.bingie.helper/'

get_setting = KODIPLUGIN.get_setting
set_setting = KODIPLUGIN.set_setting
get_localized = KODIPLUGIN.get_localized

encode_url = bingie.parser.EncodeURL(u'plugin://plugin.video.tmdb.bingie.helper/').encode_url
