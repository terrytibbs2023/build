...
class KinoGerResolver(ResolveUrl):
    ...
    domains = [
        ...
        'wasuytm.store', 'ultrastream.online', 'moflix.rpmplay.xyz'
    ]
    pattern = r'(?://|\.)((?:kinoger|wasuytm|ultrastream|(?:shiid4u|player)\.upn|moflix\.(?:upns|rpmplay))\.(?:re|one|xyz|store|online))/#([A-Za-z0-9]+)'
