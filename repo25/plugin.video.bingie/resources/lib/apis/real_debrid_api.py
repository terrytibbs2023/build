...
class RealDebridAPI:
	def __init__(self):
		self.client_ID = get_setting('bingie.rd.client_id', 'empty_setting')
		if self.client_ID in ('empty_setting', ''): self.client_ID = 'X245A4XAIBGVM'
		self.token = get_setting('bingie.rd.token', 'empty_setting')
		self.secret = get_setting('bingie.rd.secret', 'empty_setting')
		self.refresh = get_setting('bingie.rd.refresh', 'empty_setting')
		self.device_code = ''
