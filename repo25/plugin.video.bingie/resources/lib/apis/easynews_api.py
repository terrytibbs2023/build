...
def import_easynews():
	...
	# if get_setting('bingie.easynews.api_version') == '0': return EasyNewsAPI()
...
class EasyNewsAPI:
	def __init__(self):
		...
		self.username = get_setting('bingie.easynews_user', 'empty_setting')
		self.password = get_setting('bingie.easynews_password', 'empty_setting')
