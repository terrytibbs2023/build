...
class Movies:
	...
	def fetch_list(self):
		...
		try:
			...
			if page_no == 1 and not self.is_external: kodi_utils.set_property('bingie.exit_params', kodi_utils.folder_path())
	...
	def build_movie_content(self, _position, _id):
		try:
			...
			set_properties({
				...
				'bingie.extras_params': extras_params,
				'bingie.options_params': options_params,
				'bingie.playback_options_params': playback_options_params,
				'bingie.browse_movie_set_params': browse_movie_set_params,
				'bingie.browse_recommended_params': browse_recommended_params,
				'bingie.browse_more_like_this_params': browse_more_like_this_params,
				'bingie.browse_in_trakt_list_params': browse_in_trakt_list_params,
				'bingie.trakt_manager_params': trakt_manager_params,
				'bingie.personal_manager_params': personal_manager_params,
				'bingie.tmdb_manager_params': tmdb_manager_params,
				'bingie.favorites_manager_params': favorites_manager_params
				})
	...
	def worker(self):
		...
		self.watched_title = 'Trakt' if self.watched_indicators == 1 else 'Bingie'
