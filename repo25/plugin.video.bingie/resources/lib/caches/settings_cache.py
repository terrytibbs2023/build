...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('bingie.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('bingie.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('bingie.%s' % setting_id)
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict[get_setting('bingie.%s' % setting)])

def set_string(params):
	current_value = get_setting('bingie.%s' % params['setting_id'])
...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('bingie.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('bingie.%s' % setting_id)
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_bingie', 'setting_type': 'boolean', 'setting_default': 'false'},
{'setting_id': 'addon_icon_choice', 'setting_type': 'string', 'setting_default': 'resources/media/addon_icons/bingieam_icon_01.png'},
...
{'setting_id': 'update.username', 'setting_type': 'string', 'setting_default': 'BingieAnonyMouse'},
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': 'BingieAnonyMouse.github.io'},
#==================== Watched Indicators
{'setting_id': 'watched_indicators', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'Bingie', '1': 'Trakt'}},
#======+============= Trakt Cache
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.bingie/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.bingie/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.bingie/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.bingie/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'addon_icon_choice_name', 'setting_type': 'string', 'setting_default': 'bingieam_icon_01'},
