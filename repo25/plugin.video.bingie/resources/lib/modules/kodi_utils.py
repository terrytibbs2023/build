...
def get_icon(image_name, image_folder='icons'):
	return translatePath('special://home/addons/plugin.video.bingie/resources/media/%s/%s.png' % (image_folder, image_name))
...
def get_all_icon_vars():
	icon_items = list_dirs(translatePath('special://home/addons/plugin.video.bingie/resources/media/icons'))[1]
