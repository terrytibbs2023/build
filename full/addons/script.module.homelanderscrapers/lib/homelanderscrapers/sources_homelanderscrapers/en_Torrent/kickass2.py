...
from homelanderscrapers import parse_qs, urlencode, quote_plus, unquote_plus, urljoin
from homelanderscrapers.modules import cache, cleantitle, client, debrid, log_utils, source_utils
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['kick4ss.com', 'kickasstorrents.id', 'kickasstorrents.bz', 'kkickass.com', 'kkat.net', 'kickasst.net', 'thekat.cc', 'kickasshydra.net', 'kickass.onl', 'thekat.info', 'kickass.cm', 'kickasstorrents.to', 'kickasstorrents.pw', 'kickasstorrents.cr', 'kat.am', 'kickasstorrents.cr', 'katcr.to', 'kickass.sx']
