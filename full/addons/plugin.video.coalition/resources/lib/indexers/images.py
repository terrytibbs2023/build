...
icon_directory = translate_path('special://home/addons/plugin.video.coalition/resources/media')

icon = translate_path('special://home/addons/plugin.video.coalition/icon.png')
...
class Images():
	...
	def delete_image(self):
		...
		set_property('coalition.home_window.delete_image_finished', 'true')
