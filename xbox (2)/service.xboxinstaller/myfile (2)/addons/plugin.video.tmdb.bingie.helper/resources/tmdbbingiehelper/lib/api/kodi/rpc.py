from bingie.parser import try_int, find_dict_in_list
from tmdbbingiehelper.lib.addon.thread import use_thread_lock
import bingie.jsnrpc as bingie_jsnrpc

get_library = bingie_jsnrpc.get_library
get_num_credits = bingie_jsnrpc.get_num_credits
set_tags = bingie_jsnrpc.set_tags
set_watched = bingie_jsnrpc.set_watched
set_playprogress = bingie_jsnrpc.set_playprogress
get_directory = bingie_jsnrpc.get_directory


def get_jsonrpc(method=None, params=None, query_id=1):
    return bingie_jsnrpc.get_jsonrpc(method, params, query_id)
...
def get_item_details(dbid=None, method=None, key=None, properties=None):
    ...
    try:
        ...
        details['dbid'] = dbid
        from tmdbbingiehelper.lib.api.kodi.mapping import ItemMapper
...
THREAD_LOCK = 'TMDbBingieHelper.KodiLibrary.ThreadLock'
...
class KodiLibrary(object):
    ...
    def cache(self):
        try:
            ...
            from tmdbbingiehelper.lib.files.mcache import MemoryCache
