from tmdbbingiehelper.lib.addon.plugin import get_condvisibility
from bingie.window import WindowChecker
...
CV_DISABLED = (
    "!Skin.HasSetting(TMDbBingieHelper.Service) + "
...
CV_FULLSCREEN_LISTITEM = ("Skin.HasSetting(TMDbBingieHelper.UseLocalWidgetContainer) + !String.IsEmpty(Window.Property(TMDbBingieHelper.WidgetContainer))")
