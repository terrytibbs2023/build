...
oscar_winners = (
	545611, 776503, 581734, 496243, 490132, 399055, 376867, 314365, 194662, 76203, 68734, 74643, 45269, 12162, 12405, 6977,
...
media_lists = (
		...
		"'imdb_keyword%'",
		"'imdb_blunders%'",
		"'coalition_FURK_T_FILE%'",
		"'coalition_pm_instant_transfer%'",
		"'coalition_rd_check_hash%'",
		"'coalition_AD_%'",
		"'coalition_RD_%'",
		"'coalition_FOLDER_%'",
		"'https%'",
		"'tmdb_media_images_tv%'",
		"'tmdb_company_id%'"
	)

discover_help = """\

[COLOR dodgerblue][B]coalition Discover[/B][/COLOR]

coalition Discover is a feature that allows you to browse and/or export lists that you make yourself using the filter values you provide. Only the filters you wish to use need to be assigned a value, the rest can be left blank. Once you've set your desired filters, select 'Save & Browse Results' if you want to simply start looking through the list you have made, or 'Export Search' to place your new list in one of the coalition Main Menus (Root, Movies or TV Shows). Clear your filters to start again by selecting 'CLEAR FILTERS'. Your lists are saved for 7 days, and can be re-viewed by navigating into 'DISCOVER: History'. There are many different lists you could make using different filters, below are 2 examples:
...
- Select "[B]Browse Results[/B]" to immediately see the results or "[B]Export List[/B]" to export the
  list to coalition Root Menu or coalition Movies Menu etc"
