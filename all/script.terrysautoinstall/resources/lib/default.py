...
def extract_zip_if_new():
    ...
    # 🕵️ Prompt: Does Dave know?
    if not xbmcgui.Dialog().yesno("Lite Skin", "This will install a lite interface for slow devices like firesticks,Do you want to do that?"):
        xbmcgui.Dialog().ok("Bye then!", "")
        os._exit(1)
