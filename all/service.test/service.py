...
message = (
    ...
    "From now on, we’ll be using TorBox instead of Real‑Debrid. "
    "It’s around £2.50 per month and can be paid monthly.\n\n"
    "Press YES to hide this message permanently."
)
...
if not accepted:
    ...
    yes = dialog.yesno("Hide Message?", "Do you want to hide this message permanently?")
