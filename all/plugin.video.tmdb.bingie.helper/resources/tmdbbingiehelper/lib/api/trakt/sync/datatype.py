...
from tmdbbingiehelper.lib.api.trakt.sync.activity import SyncLastActivities
...
def progress_bg(func):
    def wrapper(self, *args, **kwargs):
        from tmdbbingiehelper.lib.addon.dialog import DialogProgressSyncBG
...
class DataType:
    ...
    def sync_data(self, **kwargs):
        ...
        from tmdbbingiehelper.lib.api.trakt.sync.itemdata import SyncItem
...
class SyncAllNextEpisodes(DataTypeEpisodes):
    ...
    def get_all_next_episodes(self, response, tmdb_id):
        ...
        from tmdbbingiehelper.lib.addon.tmdate import convert_timestamp
