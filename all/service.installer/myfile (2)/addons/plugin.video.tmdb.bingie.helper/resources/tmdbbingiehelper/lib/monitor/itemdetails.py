from tmdbbingiehelper.lib.addon.plugin import get_condvisibility, get_infolabel, convert_media_type, convert_type, get_setting
...
class ListItemDetails(ImageManipulations):
    ...
    def dbtype(self):
        ...
        def _get_fallback():
            if get_condvisibility("!Skin.HasSetting(TMDbBingieHelper.DisablePVR)"):
    ...
    def get_builtitem(self):
        ...
        def set_date_properties(li):
            ...
            li.infoproperties['Premiered_Custom'] = date_obj.strftime(get_infolabel('Skin.String(TMDbBingieHelper.Date.Format)') or '%d %b %Y')
