from tmdbbingiehelper.lib.monitor.images import ImageManipulations
from tmdbbingiehelper.lib.monitor.poller import Poller, POLL_MIN_INCREMENT
from tmdbbingiehelper.lib.monitor.listitemtools import ListItemInfoGetter
...
class ImagesMonitor(SafeThread, ListItemInfoGetter, ImageManipulations, Poller):
    _cond_on_disabled = (
        "!Skin.HasSetting(TMDbBingieHelper.EnableCrop) + "
        "!Skin.HasSetting(TMDbBingieHelper.EnableBlur) + "
        "!Skin.HasSetting(TMDbBingieHelper.EnableDesaturate) + "
        "!Skin.HasSetting(TMDbBingieHelper.EnableColors)")
