class TMDbMethods():
    ...
    def get_genres(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_genres
    ...
    def get_tmdb_multisearch_validfy(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_tmdb_multisearch_validfy
    ...
    def get_tmdb_multisearch_request(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_tmdb_multisearch_request
    ...
    def get_tmdb_multisearch(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_tmdb_multisearch
    ...
    def get_tmdb_id(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_tmdb_id
    ...
    def get_tmdb_id_request(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_tmdb_id_request
    ...
    def get_tmdb_id_from_query(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_tmdb_id_from_query
    ...
    def get_collection_tmdb_id(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_collection_tmdb_id
    ...
    def get_tmdb_id_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_tmdb_id_list
    ...
    def get_tvshow_nextaired(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_tvshow_nextaired
    ...
    def get_details_request(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_details_request
    ...
    def get_details(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_details
    ...
    def get_next_episode(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.details import get_next_episode
    ...
    def get_flatseasons_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_flatseasons_list
    ...
    def get_episode_group_episodes_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_episode_group_episodes_list
    ...
    def get_episode_group_seasons_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_episode_group_seasons_list
    ...
    def get_episode_groups_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_episode_groups_list
    ...
    def get_videos_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_videos_list
    ...
    def get_season_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_season_list
    ...
    def get_episode_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_episode_list
    ...
    def get_cast_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_cast_list
    ...
    def get_downloaded_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_downloaded_list
    ...
    def get_daily_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_daily_list
    ...
    def get_all_items_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_all_items_list
    ...
    def get_search_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_search_list
    ...
    def get_basic_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_basic_list
    ...
    def get_discover_list(self, *args, **kwargs):
        try:
            ...
            from tmdbbingiehelper.lib.api.tmdb.methods.lists import get_discover_list
