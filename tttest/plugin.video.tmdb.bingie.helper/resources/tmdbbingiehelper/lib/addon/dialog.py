...
import bingie.dialog as bingie_dialog
""" Top level module only import plugin/constants/logger """


BusyDialog = bingie_dialog.BusyDialog
busy_decorator = bingie_dialog.busy_decorator
...
class ProgressDialog(bingie_dialog.ProgressDialog):
    @staticmethod
